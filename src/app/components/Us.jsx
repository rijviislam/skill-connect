    ...
    return (
        <section className="bg-white dark:bg-gray-900">
            <div className="container px-6 py-12 mx-auto">
                <div>
                    <p className="font-bold text-green-600 dark:text-blue-400 uppercase tracking-widest">Contact Us</p>
                    <h1 className="mt-2 text-3xl font-extrabold text-gray-800 md:text-4xl dark:text-white">
                        Chat with our <span className="text-green-500">Friendly Team</span>
                    </h1>
                ...
                <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
                    <div className="grid grid-cols-1 gap-12 md:grid-cols-2">
                        <div className="p-6 rounded-lg shadow-lg bg-blue-50 dark:bg-gray-800">
                            <span className="inline-block p-3 text-green-600 rounded-full bg-blue-200/80 dark:bg-gray-800">
                            ...
                            <p className="mt-2 text-sm text-green-600 dark:text-blue-400 font-semibold">hello@skillconnect.com</p>
                        </div>
                        ...
                        <div className="p-6 rounded-lg shadow-lg bg-blue-50 dark:bg-gray-800">
                            ...
                            <p className="mt-2 text-sm text-green-600 dark:text-blue-400 font-semibold">+1 (555) 000-0000</p>
                        </div>
                        ...
                        <div className="p-6 rounded-lg shadow-lg bg-blue-50 dark:bg-gray-800">
                            ...
                            <p className="mt-2 text-sm text-green-600 dark:text-blue-400 font-semibold">100 Smith St, Collingwood, VIC 3066</p>
                        </div>
                        ...
                        <div className="p-6 rounded-lg shadow-lg bg-blue-50 dark:bg-gray-800">
                            ...
                            <p className="mt-2 text-sm text-green-600 dark:text-blue-400 font-semibold">Start new chat</p>
                        </div>
                    </div>
                    ...
                    <div className="p-6 py-6 rounded-lg bg-white dark:bg-gray-800 md:p-8 shadow-lg">
                        <form ref={form} onSubmit={sendEmail}>
                            ...
                            <button 
                                type="submit" 
                                className="w-full px-6 py-3 mt-4 text-sm font-semibold text-white bg-green-600 rounded-lg hover:bg-green-500 focus:ring-4 focus:ring-blue-300"
                            >
                                Send Message
                            </button>
                        </form>
