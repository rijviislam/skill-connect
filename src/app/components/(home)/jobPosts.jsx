...
const JobPosts = () => {      
    ...
    return (
        <div>
            <h2 className="container mx-auto text-left text-4xl font-medium text-[#8A2BE2] mb-7 mt-8 flex items-center">
            ...
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 pl-5">
                {jobPosts.length > 0 ? (
                    jobPosts.map((job) => (
                        <div key={job._id}>
                            <Card className="bg-violet-50 h-[350px] shadow-md border-violet-500 border-2 hover:bg-violet-100 p-4 transition-all duration-300">
                                ...
                                <CardBody className="px-0 py-0 text-small text-default-400 overflow-hidden" style={{ height: '150px' }}>
                                    <p className="mb-2 flex items-center">
                                        ...
                                        <strong className="font-bold text-black">Description:</strong> {job.description}
                                    </p>
                                    <p className="mb-2 flex items-center">
                                        <FaDollarSign className="mr-2 text-green-600" />
                                        <strong className="font-bold text-black">Budget:</strong> {job.budget}
                                    </p>
                                    <p className="mb-2 flex items-center">
                                        <FaClock className="mr-2 text-orange-600" />
                                        <strong className="font-bold text-black">Timeline:</strong> {job.timeline}
                                    </p>
                                    <p className="mb-2 flex items-center">
                                        <FaTools className="mr-2 text-purple-600" />
                                        <strong className="font-bold text-black">Skills:</strong> {job.skills.join(', ')}
                                    </p>
                                    <hr className="my-2" />
                                </CardBody>
