    ...
    <div className="py-12">
      <div className="container mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center space-y-8 md:space-y-0 md:space-x-8">
          ...
          <div 
            data-aos="zoom-in-up" 
            className="flex flex-col items-center text-center p-4 w-60 h-56 border-2 hover:border-violet-700 bg-violet-50 shadow-md rounded-2xl transform transition-transform hover:scale-105 hover:bg-violet-50 hover:shadow-xl">
