    ...
    <div>
      <div className="flex flex-col items-center p-4 text-black">
        ...
        <div className="bg-green-100 p-4 rounded-lg shadow-md w-80 text-center transition-transform transform hover:scale-105 hover:shadow-lg border border-transparent hover:border-green-900 duration-300">
          <Image
            src={
              profileData.image || "https://i.postimg.cc/wT791byT/2919906.png"
            }
            alt="Profile"
            ...
            height={96}
          />
          <h2 className="text-1xl font-extrabold  mb-2 transition-colors duration-300 hover:text-green-500">
            {profileData.name}
          </h2>
          <p className="text-1xl font-extrabold text-gray-600 mb-2 transition-colors duration-300 hover:text-green-400">
            {profileData.email}
          </p>
          ...
          <Button
            onPress={onOpen}
            className="mt-4 transition-colors duration-300 bg-green-500 text-green-100 rounded hover:bg-green-600 hover:shadow-lg"
          >
            Edit Profile
          </Button>
        </div>
