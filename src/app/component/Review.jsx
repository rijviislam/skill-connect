    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <Slider {...settings}>
        {reviews.map((review, index) => (
          <div key={index} className="bg-green-50 p-8 rounded-xl shadow-xl transition-transform transform hover:scale-105 hover:bg-teal-50 hover:shadow-2xl">
            ...
            <h3 className="text-lg font-semibold text-center mb-2 text-teal-800">{review.name}</h3>
            <p className="text-center text-gray-700 mb-4 leading-relaxed max-w-[80%] mx-auto">{review.review}</p>
